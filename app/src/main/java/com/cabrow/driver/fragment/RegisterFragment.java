...
import com.cabrow.driver.adapter.VehicalTypeListAdapter;
...
import com.cabrow.driver.parse.MultiPartRequester;
...
import com.cabrow.driver.widget.MyFontEdittextView;
...
SimpleFacebook.setConfiguration(facebookConfiguration);
	...
	public void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (requestCode == RC_SIGN_IN) {
			...
			//Rokan
			//mSimpleFacebook.onActivityResult(registerActivity, requestCode, resultCode, data);
			if (mSimpleFacebook.isLogin()) {
				getFbProfile();
			} else {
				Toast.makeText(
