package com.cabrow.driver.fragment;
...
import com.cabrow.driver.base.BaseMapFragment;
import com.cabrow.driver.db.DBHelper;
import com.cabrow.driver.locationupdate.LocationHelper;
...
public class JobFragment extends BaseMapFragment implements
	...
	private void setUpMap() {
		...
		if (googleMap == null) {
			//Rokan
			//googleMap = ((MapView) jobFragmentView.findViewById(R.id.jobMap)).getMap();
